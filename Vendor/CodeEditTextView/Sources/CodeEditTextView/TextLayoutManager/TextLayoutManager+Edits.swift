...
extension TextLayoutManager: NSTextStorageDelegate {
    ...
    public func textStorage(
        ...
        // Edits can shrink the widest line (or remove it). Recompute after the
        // next layout pass so horizontal document width can decrease.
        maxLineWidthNeedsRecompute = true
